...
export async function createClub(name) {
  ...
  const club = { id: crypto.randomUUID(), name: name || "Mon Équipe", createdAt: new Date().toISOString() };
...
export function publicUser(u) {
  return { id: u.id, username: u.username, role: u.role, permissionLevel: u.permissionLevel || "readonly", clubId: u.clubId, createdAt: u.createdAt };
}
