...
export function useTeamData() {
        ...
        try {
          await fetch("/api/data", {
            ...
            body: JSON.stringify({
              ...
              injuries, developmentGoals, liveSessions, teamName, seasons, currentSeason, noteWeightHead,
            }),
          });
          setSaveState("saved");
        } catch (e) {
  ...
  }, [players, staff, matches, trainings, evaluations, availabilities, exerciseLibrary, bodyMetrics, leagueMatches, opponentProfiles, injuries, developmentGoals, liveSessions, teamName, seasons, currentSeason, noteWeightHead, loaded]);
  ...
  return {
    ...
    noteWeightHead, setNoteWeightHead,
