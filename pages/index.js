  ...
  return (
    <div className="app-root">
      <style>{`
        ...
        .brand-name-input { font-family:'Space Grotesk',sans-serif; font-size:15px; background:rgba(15,23,42,0.06); border:1px solid var(--gold); border-radius:4px; padding:2px 6px; color:var(--chalk); width:100%; }
        ...
        .season-add-btn { background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk-dim); border-radius:4px; width:16px; height:16px; display:flex; align-items:center; justify-content:center; cursor:pointer; flex-shrink:0; }
        ...
        .global-search-input { width:100%; background:rgba(15,23,42,0.05); border:1px solid var(--pitch-line); border-radius:7px; padding:7px 10px 7px 32px; font-size:12.5px; font-family:'Inter',sans-serif; color:var(--chalk); }
        .global-search-input:focus { outline:none; border-color:var(--gold); box-shadow:0 0 0 3px rgba(37,99,235,0.18); }
        .search-dropdown { position:absolute; top:calc(100% + 6px); left:0; right:0; background:var(--pitch-mid); border:1px solid var(--pitch-line); border-radius:8px; box-shadow:0 8px 24px rgba(15,23,42,0.12); z-index:50; max-height:320px; overflow-y:auto; }
        ...
        .search-result:hover { background:rgba(37,99,235,0.08); }
        ...
        .metric-card { background:var(--pitch-mid); border:1px solid var(--pitch-line); border-radius:10px; padding:16px; display:flex; align-items:flex-start; gap:12px; box-shadow:0 1px 2px rgba(15,23,42,0.05); }
        .metric-icon { color:var(--gold); margin-top:0; background:rgba(37,99,235,0.12); border-radius:8px; width:32px; height:32px; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        ...
        .panel { background:var(--pitch-mid); border:1px solid var(--pitch-line); border-radius:10px; padding:20px; margin-bottom:20px; box-shadow:0 1px 2px rgba(15,23,42,0.04); }
        ...
        .match-list-row:hover { background:rgba(15,23,42,0.04); }
        ...
        .stats-table tbody tr:nth-child(even) { background:rgba(15,23,42,0.015); }
        .stats-table tbody tr:hover { background:rgba(37,99,235,0.06); }
        ...
        .rank-card:hover { background:rgba(37,99,235,0.05); }
        .rank-card + .rank-card { margin-top:2px; }
        .rank-card-number { width:26px; height:26px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-family:'IBM Plex Mono',monospace; font-size:12px; font-weight:600; color:var(--chalk-dim); background:rgba(15,23,42,0.05); flex-shrink:0; }
        ...
        .player-chip { display:flex; align-items:center; gap:8px; background:rgba(15,23,42,0.05); border:1px solid var(--pitch-line); color:var(--chalk-dim); border-radius:6px; padding:5px 12px 5px 5px; font-size:13px; cursor:pointer; }
        ...
        .form-grid input, .form-grid select { background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk); border-radius:6px; padding:8px 10px; font-family:'Inter',sans-serif; font-size:13.5px; transition:border-color 0.12s ease; }
        .date-field { display:flex; align-items:center; gap:4px; }
        .date-field input { width:44px; text-align:center; background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk); border-radius:6px; padding:8px 4px; font-family:'IBM Plex Mono',monospace; font-size:13.5px; }
        .date-field input:nth-child(5) { width:60px; }
        .date-field input:focus { outline:none; border-color:var(--gold); box-shadow:0 0 0 3px rgba(37,99,235,0.18); }
        .date-field-sep { color:var(--chalk-dim); }
        .form-grid input:focus, .form-grid select:focus, .cell-input:focus, .filter-row select:focus { outline:none; border-color:var(--gold); box-shadow:0 0 0 3px rgba(37,99,235,0.18); }
        .bulk-textarea { width:100%; background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk); border-radius:6px; padding:10px; font-family:'IBM Plex Mono',monospace; font-size:13px; resize:vertical; }
        ...
        .pitch-board { background:repeating-linear-gradient(0deg, rgba(15,23,42,0.015) 0px, rgba(15,23,42,0.015) 1px, transparent 1px, transparent 24px); border:1px dashed var(--pitch-line); border-radius:10px; padding:16px; display:flex; flex-direction:column-reverse; gap:10px; }

        .live-team-toggle { display:flex; gap:10px; }
        .live-team-btn { flex:1; padding:16px; border-radius:10px; border:1px solid var(--pitch-line); background:rgba(15,23,42,0.04); color:var(--chalk-dim); font-family:'Space Grotesk',sans-serif; font-size:15px; font-weight:600; cursor:pointer; transition:all 0.12s ease; }
        .live-team-btn.active { background:rgba(37,99,235,0.15); border-color:var(--gold); color:var(--chalk); }
        .live-pitch-wrap { display:flex; justify-content:center; }
        .live-pitch-svg { width:100%; max-width:340px; height:auto; border-radius:10px; border:1px solid var(--pitch-line); box-shadow:0 2px 8px rgba(15,23,42,0.08); }
        ...
        .live-tag-btn { padding:14px 10px; border-radius:8px; border:2px solid var(--pitch-line); background:rgba(15,23,42,0.03); color:var(--chalk); font-size:13px; font-weight:600; cursor:pointer; transition:all 0.12s ease; }
        .live-tag-btn:hover:not(:disabled) { background:rgba(15,23,42,0.07); }
        .live-tag-btn:disabled { opacity:0.35; cursor:not-allowed; }
        .live-goal-prompt { border:2px solid var(--gold); background:rgba(37,99,235,0.04); }
        .pitch-row { display:flex; flex-wrap:wrap; gap:10px; justify-content:center; padding:8px 0; }
        .pitch-chip { display:flex; align-items:center; gap:6px; background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk); border-radius:6px; padding:5px 12px 5px 5px; font-size:12.5px; cursor:pointer; position:relative; }
        .pitch-chip:hover { border-color:var(--gold); }
        .pitch-chip.empty { background:rgba(15,23,42,0.02); border-style:dashed; padding:8px 14px; color:var(--chalk-dim); }
        .pitch-chip.selected { border-color:var(--gold); box-shadow:0 0 0 2px rgba(37,99,235,0.35); }
        ...
        .unavail-chip { display:inline-flex; align-items:center; gap:4px; padding:3px 10px; border-radius:6px; font-size:11.5px; background:rgba(220,38,38,0.1); border:1px solid rgba(220,38,38,0.25); color:var(--chalk); }
        ...
        .eval-skill-input input { background:rgba(15,23,42,0.06); border:1px solid var(--pitch-line); color:var(--chalk); border-radius:6px; padding:6px 8px; font-family:'IBM Plex Mono',monospace; font-size:13px; }
